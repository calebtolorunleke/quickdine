...
import membershipImg from "../../assets/membership_section_img.png";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center lg:pl-6">
          ...
          <p className="text-sm text-black/55 mb-8 leading-relaxed">
            ...
            collaborations, private dining club events, and table guarantees at
            high-demand tables.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              <BadgeCheck
                size={20}
                className="text-[#775a19] shrink-0 mt-0.5"
              />
              <div>
            ...
            <div className="flex gap-4">
              <Armchair size={20} className="text-[#775a19] shrink-0 mt-0.5" />
              <div>
                <h4 className="text-sm text-primary">
